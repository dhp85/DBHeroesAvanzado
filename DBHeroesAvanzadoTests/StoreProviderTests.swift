...
final class StoreProviderTests: XCTestCase {
    ...
    func test_addHeroes_shouldReturnTheItemsInserted() throws {
        ...
        let apiHero = APIHero(id: "123", name: "Goku", photo: "photo", favorite: false, herodescripcion: "fuerte")
        ...
        XCTAssertEqual(hero.herodescripcion, apiHero.herodescripcion)
    ...
    func test_fetchHeroes_shouldBeSortedAsc() throws {
        ...
        let initialCount = sut.fetchHeroes(filter: nil).count
        let apiHero = APIHero(id: "123", name: "Goku", photo: "photo", favorite: false, herodescripcion: "fuerte")
        let apiHero2 = APIHero(id: "123", name: "Vegeta", photo: "photo", favorite: false, herodescripcion: "fuerte")
        ...
        XCTAssertEqual(hero.herodescripcion, apiHero2.herodescripcion)
